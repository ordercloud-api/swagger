...
AdminUserApi::AdminUserApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::shared_ptr<Object>> AdminUserApi::create(std::shared_ptr<User> user)
{
    
    // verify the required parameter 'user' is set
    if (user == nullptr)
    {
        throw ApiException(400, U("Missing required parameter 'user' when calling AdminUserApi->create"));
    }
    
    
    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/adminusers");
    ...
    {
        throw ApiException(400, U("AdminUserApi->create does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("AdminUserApi->create does not consume any supported media type"));
    }    
...
pplx::task<void> AdminUserApi::delete(utility::string_t userID)
{
    
    
    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/adminusers/{userID}");
    ...
    {
        throw ApiException(400, U("AdminUserApi->delete does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("AdminUserApi->delete does not consume any supported media type"));
    }    
...
pplx::task<std::shared_ptr<Object>> AdminUserApi::get(utility::string_t userID)
{
    ...
    {
        throw ApiException(400, U("AdminUserApi->get does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("AdminUserApi->get does not consume any supported media type"));
    }    
...
pplx::task<std::shared_ptr<Object>> AdminUserApi::list(utility::string_t search, utility::string_t searchOn, utility::string_t sortBy, int32_t page, int32_t pageSize)
{
    ...
    {
        throw ApiException(400, U("AdminUserApi->list does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("AdminUserApi->list does not consume any supported media type"));
    }    
...
pplx::task<void> AdminUserApi::patch(utility::string_t userID, std::shared_ptr<User> user)
{
    
    // verify the required parameter 'user' is set
    if (user == nullptr)
    {
        throw ApiException(400, U("Missing required parameter 'user' when calling AdminUserApi->patch"));
    }
    ...
    {
        throw ApiException(400, U("AdminUserApi->patch does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("AdminUserApi->patch does not consume any supported media type"));
    }    
...
pplx::task<std::shared_ptr<Object>> AdminUserApi::update(utility::string_t userID, std::shared_ptr<User> user)
{
    
    // verify the required parameter 'user' is set
    if (user == nullptr)
    {
        throw ApiException(400, U("Missing required parameter 'user' when calling AdminUserApi->update"));
    }
    ...
    {
        throw ApiException(400, U("AdminUserApi->update does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("AdminUserApi->update does not consume any supported media type"));
    }    
