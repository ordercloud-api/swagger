...
BuyerApi::BuyerApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::shared_ptr<Object>> BuyerApi::create(std::shared_ptr<Buyer> company)
{
    
    // verify the required parameter 'company' is set
    if (company == nullptr)
    {
        throw ApiException(400, U("Missing required parameter 'company' when calling BuyerApi->create"));
    }
    
    
    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/buyers");
    ...
    {
        throw ApiException(400, U("BuyerApi->create does not produce any supported media type"));
    }    
    ...
    else if( consumeHttpContentTypes.find(U("multipart/form-data")) != consumeHttpContentTypes.end() )
    {
        ...
        if(company.get())
        {
            company->toMultipart(multipart, U("company"));
        }
    ...
    {
        throw ApiException(415, U("BuyerApi->create does not consume any supported media type"));
    }    
...
pplx::task<void> BuyerApi::delete(utility::string_t buyerID)
{
    
    
    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/buyers/{buyerID}");
    ...
    {
        throw ApiException(400, U("BuyerApi->delete does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("BuyerApi->delete does not consume any supported media type"));
    }    
...
pplx::task<std::shared_ptr<Object>> BuyerApi::get(utility::string_t buyerID)
{
    ...
    {
        throw ApiException(400, U("BuyerApi->get does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("BuyerApi->get does not consume any supported media type"));
    }    
...
pplx::task<std::shared_ptr<Object>> BuyerApi::list(utility::string_t search, int32_t page, int32_t pageSize)
{
    ...
    {
        throw ApiException(400, U("BuyerApi->list does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("BuyerApi->list does not consume any supported media type"));
    }    
...
pplx::task<std::shared_ptr<Object>> BuyerApi::update(utility::string_t buyerID, std::shared_ptr<Buyer> company)
{
    
    // verify the required parameter 'company' is set
    if (company == nullptr)
    {
        throw ApiException(400, U("Missing required parameter 'company' when calling BuyerApi->update"));
    }
    ...
    {
        throw ApiException(400, U("BuyerApi->update does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("BuyerApi->update does not consume any supported media type"));
    }    
