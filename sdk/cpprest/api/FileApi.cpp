...
FileApi::FileApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::shared_ptr<Object>> FileApi::get(utility::string_t fileID)
{
    ...
    {
        throw ApiException(400, U("FileApi->get does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("FileApi->get does not consume any supported media type"));
    }    
...
pplx::task<std::shared_ptr<Object>> FileApi::list(int32_t page, int32_t pageSize)
{
    ...
    {
        throw ApiException(400, U("FileApi->list does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("FileApi->list does not consume any supported media type"));
    }    
...
pplx::task<std::shared_ptr<Object>> FileApi::postFileData(utility::string_t filename)
{
    ...
    {
        throw ApiException(400, U("FileApi->postFileData does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("FileApi->postFileData does not consume any supported media type"));
    }    
    ...
    .then([=](web::http::http_response response)
    {
		...
		{
			throw ApiException(response.status_code()
				, U("error calling postFileData: ") + response.reason_phrase()
				, std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
		}
        ...
        if(response.headers().has(U("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , U("error calling postFileData: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
