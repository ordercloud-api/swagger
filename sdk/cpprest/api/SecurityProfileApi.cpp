...
SecurityProfileApi::SecurityProfileApi( std::shared_ptr<ApiClient> apiClient )
...
pplx::task<std::shared_ptr<Object>> SecurityProfileApi::get(utility::string_t securityProfileID)
{
    
    
    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/SecurityProfiles/{securityProfileID}");
    boost::replace_all(path, U("{") U("securityProfileID") U("}"), ApiClient::parameterToString(securityProfileID));
    ...
    {
        throw ApiException(400, U("SecurityProfileApi->get does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("SecurityProfileApi->get does not consume any supported media type"));
    }    
...
pplx::task<std::shared_ptr<Object>> SecurityProfileApi::list(utility::string_t search, utility::string_t searchOn, utility::string_t sortBy, int32_t page, int32_t pageSize)
{
    
    
    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = U("/SecurityProfiles");
    ...
    {
        throw ApiException(400, U("SecurityProfileApi->list does not produce any supported media type"));
    }    
    ...
    {
        throw ApiException(415, U("SecurityProfileApi->list does not consume any supported media type"));
    }    
