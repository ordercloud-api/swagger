...
class ApprovalRuleApi extends Controller
{
    /**
     * Constructor
     */
     ...
     *
     * @param String $buyerID ID of the buyer. (required)
     * @param String $approvalRuleID ID of the approval rule. (required)
     *
     * @return Http response
     */
    public function delete($buyerID, $approvalRuleID)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function get($buyerID, $approvalRuleID)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function patch($buyerID, $approvalRuleID)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function update($buyerID, $approvalRuleID)
    {
        $input = Request::all();
