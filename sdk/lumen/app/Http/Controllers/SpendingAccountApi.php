...
class SpendingAccountApi extends Controller
{
    /**
     * Constructor
     */
     ...
     *
     * @param String $buyerID ID of the buyer. (required)
     * @param String $spendingAccountID ID of the spending account. (required)
     *
     * @return Http response
     */
    public function delete($buyerID, $spendingAccountID)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function get($buyerID, $spendingAccountID)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function patch($buyerID, $spendingAccountID)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function update($buyerID, $spendingAccountID)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function deleteAssignment($buyerID, $spendingAccountID)
    {
        $input = Request::all();
