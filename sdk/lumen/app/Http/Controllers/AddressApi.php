...
class AddressApi extends Controller
{
     ...
     * @return Http response
     */
    public function delete($buyerID, $addressID)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function get($buyerID, $addressID)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function patch($buyerID, $addressID)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function update($buyerID, $addressID)
    {
        $input = Request::all();
     ...
     * @return Http response
     */
    public function deleteAssignment($buyerID, $addressID)
    {
        $input = Request::all();
