...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/User', 'model/ImpersonateTokenRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/User'), require('../model/ImpersonateTokenRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.OrderCloud) {
      root.OrderCloud = {};
    }
    root.OrderCloud.UserApi = factory(root.OrderCloud.ApiClient, root.OrderCloud.User, root.OrderCloud.ImpersonateTokenRequest);
  }
}(this, function(ApiClient, User, ImpersonateTokenRequest) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    this.getAccessToken = function(buyerID, userID, tokenRequest, callback) {
      ...
      // verify the required parameter 'buyerID' is set
      if (buyerID == undefined || buyerID == null) {
        throw "Missing the required parameter 'buyerID' when calling getAccessToken";
      }

      // verify the required parameter 'userID' is set
      if (userID == undefined || userID == null) {
        throw "Missing the required parameter 'userID' when calling getAccessToken";
      }

      // verify the required parameter 'tokenRequest' is set
      if (tokenRequest == undefined || tokenRequest == null) {
        throw "Missing the required parameter 'tokenRequest' when calling getAccessToken";
      }
