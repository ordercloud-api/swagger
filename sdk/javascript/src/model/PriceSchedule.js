...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OrderCloud.PriceSchedule = factory(root.OrderCloud.ApiClient, root.OrderCloud.ShipmentItem);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('PriceBreaks')) {
        obj['PriceBreaks'] = ApiClient.convertToType(data['PriceBreaks'], [ShipmentItem]);
      }
  ...
  /**
   * @member {Array.<module:model/ShipmentItem>} PriceBreaks
   */
