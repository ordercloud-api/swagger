...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ScopeTimeNumber')) {
        obj['ScopeTimeNumber'] = ApiClient.convertToType(data['ScopeTimeNumber'], 'Integer');
      }
      if (data.hasOwnProperty('ScopeStartDate')) {
        obj['ScopeStartDate'] = ApiClient.convertToType(data['ScopeStartDate'], 'Date');
      }
      ...
      if (data.hasOwnProperty('ExpireAfterNumber')) {
        obj['ExpireAfterNumber'] = ApiClient.convertToType(data['ExpireAfterNumber'], 'Integer');
      }
  ...
  /**
   * @member {Integer} ScopeTimeNumber
   */
  exports.prototype['ScopeTimeNumber'] = undefined;
  /**
   * @member {Date} ScopeStartDate
   */
  ...
  /**
   * @member {Integer} ExpireAfterNumber
   */
