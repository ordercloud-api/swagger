...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.FileApi();
  });
  ...
  describe('FileApi', function() {
    ...
    describe('postFileData', function() {
      it('should call postFileData successfully', function(done) {
        //uncomment below and update the code to test postFileData
        //instance.postFileData(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
