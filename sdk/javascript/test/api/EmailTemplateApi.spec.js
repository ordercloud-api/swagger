...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.EmailTemplateApi();
  });
  ...
  describe('EmailTemplateApi', function() {
    ...
    describe('resetToDefault', function() {
      it('should call resetToDefault successfully', function(done) {
        //uncomment below and update the code to test resetToDefault
        //instance.resetToDefault(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
