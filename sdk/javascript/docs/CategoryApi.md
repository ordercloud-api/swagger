...
------------- | ------------- | -------------
[**callDelete**](CategoryApi.md#callDelete) | **DELETE** /buyers/{buyerID}/categories/{categoryID} | 
...
apiInstance.callDelete(buyerID, categoryID, callback);
```
...
apiInstance.create(buyerID, category, callback);
```
...
# **deleteAssignment**
> deleteAssignment(buyerID, categoryID, opts)
...
apiInstance.deleteAssignment(buyerID, categoryID, opts, callback);
```
...
apiInstance.deleteProductAssignment(buyerID, categoryID, productID, callback);
```
...
apiInstance.get(buyerID, categoryID, callback);
```
...
var opts = { 
  'parentID': "parentID_example", // String | ID of the parent.
...
# **listChildren**
> Object listChildren(buyerID, parentID, opts)
...
apiInstance.listChildren(buyerID, parentID, opts, callback);
```
...
> Object listProductAssignments(buyerID, opts)
...
apiInstance.listProductAssignments(buyerID, opts, callback);
```
...
apiInstance.patch(buyerID, categoryID, category, callback);
```
...
apiInstance.saveAssignment(buyerID, categoryAssignment, callback);
```
...
apiInstance.saveProductAssignment(buyerID, productAssignment, callback);
```
...
apiInstance.update(buyerID, categoryID, category, callback);
```
