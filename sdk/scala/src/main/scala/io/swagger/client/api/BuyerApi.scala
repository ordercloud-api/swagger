...
class BuyerApi(val defBasePath: String = "https://api.ordercloud.io/v1",
   ...
   * @return Any
   */
  def create (company: Buyer) : Option[Any] = {
    // create path and map variables
    val path = "/buyers".replaceAll("\\{format\\}","json")
  ...
  def delete (buyerID: String)  = {
    // create path and map variables
    val path = "/buyers/{buyerID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "buyerID" + "\\}",apiInvoker.escape(buyerID))
   ...
   * @return Any
   */
  def get (buyerID: String) : Option[Any] = {
    // create path and map variables
    val path = "/buyers/{buyerID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "buyerID" + "\\}",apiInvoker.escape(buyerID))
   ...
   * @return Any
   */
  def list (search: String, page: Integer, pageSize: Integer) : Option[Any] = {
    // create path and map variables
    val path = "/buyers".replaceAll("\\{format\\}","json")
    val contentTypes = List("application/json")
    val contentType = contentTypes(0)
...
if(String.valueOf(pageSize) != "null") queryParams += "pageSize" -> pageSize.toString
   ...
   * @return Any
   */
  def update (buyerID: String, company: Buyer) : Option[Any] = {
    // create path and map variables
    val path = "/buyers/{buyerID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "buyerID" + "\\}",apiInvoker.escape(buyerID))
