...
class UserGroupApi(val defBasePath: String = "https://api.ordercloud.io/v1",
   ...
   * @return Any
   */
  def create (buyerID: String, group: UserGroup) : Option[Any] = {
    // create path and map variables
    val path = "/buyers/{buyerID}/usergroups".replaceAll("\\{format\\}","json").replaceAll("\\{" + "buyerID" + "\\}",apiInvoker.escape(buyerID))
   ...
   * @return void
   */
  def delete (buyerID: String, userGroupID: String)  = {
    // create path and map variables
    val path = "/buyers/{buyerID}/usergroups/{userGroupID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "buyerID" + "\\}",apiInvoker.escape(buyerID))

.replaceAll("\\{" + "userGroupID" + "\\}",apiInvoker.escape(userGroupID))
   ...
   * @return void
   */
  def deleteUserAssignment (buyerID: String, userGroupID: String, userID: String)  = {
    // create path and map variables
    val path = "/buyers/{buyerID}/usergroups/{userGroupID}/assignments/{userID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "buyerID" + "\\}",apiInvoker.escape(buyerID))
...
.replaceAll("\\{" + "userID" + "\\}",apiInvoker.escape(userID))
   ...
   * @return Any
   */
  def get (buyerID: String, userGroupID: String) : Option[Any] = {
    // create path and map variables
    val path = "/buyers/{buyerID}/usergroups/{userGroupID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "buyerID" + "\\}",apiInvoker.escape(buyerID))
...
if(String.valueOf(pageSize) != "null") queryParams += "pageSize" -> pageSize.toString
   ...
   * @return Any
   */
  def listUserAssignments (buyerID: String, userGroupID: String, userID: String, page: Integer, pageSize: Integer) : Option[Any] = {
    // create path and map variables
    val path = "/buyers/{buyerID}/usergroups/assignments".replaceAll("\\{format\\}","json").replaceAll("\\{" + "buyerID" + "\\}",apiInvoker.escape(buyerID))
...
if(String.valueOf(pageSize) != "null") queryParams += "pageSize" -> pageSize.toString
   ...
   * @return void
   */
  def patch (buyerID: String, userGroupID: String, group: UserGroup)  = {
    // create path and map variables
    val path = "/buyers/{buyerID}/usergroups/{userGroupID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "buyerID" + "\\}",apiInvoker.escape(buyerID))
...
.replaceAll("\\{" + "userGroupID" + "\\}",apiInvoker.escape(userGroupID))
   ...
   * @return void
   */
  def saveUserAssignment (buyerID: String, userGroupAssignment: UserGroupAssignment)  = {
    // create path and map variables
    val path = "/buyers/{buyerID}/usergroups/assignments".replaceAll("\\{format\\}","json").replaceAll("\\{" + "buyerID" + "\\}",apiInvoker.escape(buyerID))
    ...
    var postBody: AnyRef = userGroupAssignment
   ...
   * @return Any
   */
  def update (buyerID: String, userGroupID: String, group: UserGroup) : Option[Any] = {
    // create path and map variables
    val path = "/buyers/{buyerID}/usergroups/{userGroupID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "buyerID" + "\\}",apiInvoker.escape(buyerID))
