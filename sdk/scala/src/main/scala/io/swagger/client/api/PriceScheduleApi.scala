...
class PriceScheduleApi(val defBasePath: String = "https://api.ordercloud.io/v1",
   ...
   * @return Any
   */
  def create (priceSchedule: PriceSchedule) : Option[Any] = {
    // create path and map variables
    val path = "/priceschedules".replaceAll("\\{format\\}","json")
    ...
    var postBody: AnyRef = priceSchedule
   ...
   * @return void
   */
  def delete (priceScheduleID: String)  = {
    // create path and map variables
    val path = "/priceschedules/{priceScheduleID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "priceScheduleID" + "\\}",apiInvoker.escape(priceScheduleID))
   ...
   * @return void
   */
  def deletePriceBreak (priceScheduleID: String, quantity: Integer)  = {
    // create path and map variables
    val path = "/priceschedules/{priceScheduleID}/PriceBreaks".replaceAll("\\{format\\}","json").replaceAll("\\{" + "priceScheduleID" + "\\}",apiInvoker.escape(priceScheduleID))
    ...
    if(String.valueOf(quantity) != "null") queryParams += "quantity" -> quantity.toString
   ...
   * @return Any
   */
  def get (priceScheduleID: String) : Option[Any] = {
    // create path and map variables
    val path = "/priceschedules/{priceScheduleID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "priceScheduleID" + "\\}",apiInvoker.escape(priceScheduleID))
...
if(String.valueOf(pageSize) != "null") queryParams += "pageSize" -> pageSize.toString
   ...
   * @return Any
   */
  def patch (priceScheduleID: String, priceSchedule: PriceSchedule) : Option[Any] = {
    // create path and map variables
    val path = "/priceschedules/{priceScheduleID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "priceScheduleID" + "\\}",apiInvoker.escape(priceScheduleID))
   ...
   * @return Any
   */
  def savePriceBreak (priceScheduleID: String, priceBreak: PriceBreak) : Option[Any] = {
    // create path and map variables
    val path = "/priceschedules/{priceScheduleID}/PriceBreaks".replaceAll("\\{format\\}","json").replaceAll("\\{" + "priceScheduleID" + "\\}",apiInvoker.escape(priceScheduleID))
    ...
    var postBody: AnyRef = priceBreak
   ...
   * @return Any
   */
  def update (priceScheduleID: String, priceSchedule: PriceSchedule) : Option[Any] = {
    // create path and map variables
    val path = "/priceschedules/{priceScheduleID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "priceScheduleID" + "\\}",apiInvoker.escape(priceScheduleID))
