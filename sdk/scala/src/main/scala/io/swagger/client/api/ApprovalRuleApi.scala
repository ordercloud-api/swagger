...
class ApprovalRuleApi(val defBasePath: String = "https://api.ordercloud.io/v1",
   ...
   * @return Any
   */
  def create (buyerID: String, approvalRule: ApprovalRule) : Option[Any] = {
    // create path and map variables
    val path = "/buyers/{buyerID}/approvalrules".replaceAll("\\{format\\}","json").replaceAll("\\{" + "buyerID" + "\\}",apiInvoker.escape(buyerID))
    ...
    var postBody: AnyRef = approvalRule
   ...
   * @return void
   */
  def delete (buyerID: String, approvalRuleID: String)  = {
    // create path and map variables
    val path = "/buyers/{buyerID}/approvalrules/{approvalRuleID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "buyerID" + "\\}",apiInvoker.escape(buyerID))

.replaceAll("\\{" + "approvalRuleID" + "\\}",apiInvoker.escape(approvalRuleID))
   ...
   * @return Any
   */
  def get (buyerID: String, approvalRuleID: String) : Option[Any] = {
    // create path and map variables
    val path = "/buyers/{buyerID}/approvalrules/{approvalRuleID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "buyerID" + "\\}",apiInvoker.escape(buyerID))
...
if(String.valueOf(pageSize) != "null") queryParams += "pageSize" -> pageSize.toString
   ...
   * @return Any
   */
  def patch (buyerID: String, approvalRuleID: String, partialApprovalRule: ApprovalRule) : Option[Any] = {
    // create path and map variables
    val path = "/buyers/{buyerID}/approvalrules/{approvalRuleID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "buyerID" + "\\}",apiInvoker.escape(buyerID))
...
.replaceAll("\\{" + "approvalRuleID" + "\\}",apiInvoker.escape(approvalRuleID))
    ...
    var postBody: AnyRef = partialApprovalRule
   ...
   * @return Any
   */
  def update (buyerID: String, approvalRuleID: String, approvalRule: ApprovalRule) : Option[Any] = {
    // create path and map variables
    val path = "/buyers/{buyerID}/approvalrules/{approvalRuleID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "buyerID" + "\\}",apiInvoker.escape(buyerID))
