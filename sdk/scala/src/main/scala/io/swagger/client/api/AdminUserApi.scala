...
class AdminUserApi(val defBasePath: String = "https://api.ordercloud.io/v1",
   ...
   * @return Any
   */
  def create (user: User) : Option[Any] = {
    // create path and map variables
    val path = "/adminusers".replaceAll("\\{format\\}","json")
  ...
  def delete (userID: String)  = {
    // create path and map variables
    val path = "/adminusers/{userID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "userID" + "\\}",apiInvoker.escape(userID))
   ...
   * @return Any
   */
  def get (userID: String) : Option[Any] = {
    // create path and map variables
    val path = "/adminusers/{userID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "userID" + "\\}",apiInvoker.escape(userID))
...
if(String.valueOf(pageSize) != "null") queryParams += "pageSize" -> pageSize.toString
   ...
   * @return void
   */
  def patch (userID: String, user: User)  = {
    // create path and map variables
    val path = "/adminusers/{userID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "userID" + "\\}",apiInvoker.escape(userID))
   ...
   * @return Any
   */
  def update (userID: String, user: User) : Option[Any] = {
    // create path and map variables
    val path = "/adminusers/{userID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "userID" + "\\}",apiInvoker.escape(userID))
