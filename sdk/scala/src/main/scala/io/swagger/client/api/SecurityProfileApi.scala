...
class SecurityProfileApi(val defBasePath: String = "https://api.ordercloud.io/v1",
   ...
   * @return Any
   */
  def get (securityProfileID: String) : Option[Any] = {
    // create path and map variables
    val path = "/SecurityProfiles/{securityProfileID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "securityProfileID" + "\\}",apiInvoker.escape(securityProfileID))
  ...
  def list (search: String, searchOn: String, sortBy: String, page: Integer, pageSize: Integer) : Option[Any] = {
    // create path and map variables
    val path = "/SecurityProfiles".replaceAll("\\{format\\}","json")
    val contentTypes = List("application/json")
    val contentType = contentTypes(0)
