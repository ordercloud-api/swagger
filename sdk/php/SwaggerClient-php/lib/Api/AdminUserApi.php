...
class AdminUserApi
{
    ...
    {
        list($response) = $this->createWithHttpInfo($user);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function createWithHttpInfo($user)
    {
    ...
    {
        list($response) = $this->deleteWithHttpInfo($user_id);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function deleteWithHttpInfo($user_id)
    {
        ...
        // parse inputs
        $resourcePath = "/adminusers/{userID}";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
    ...
    {
        list($response) = $this->getWithHttpInfo($user_id);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getWithHttpInfo($user_id)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null) {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function patch($user_id, $user)
    {
        list($response) = $this->patchWithHttpInfo($user_id, $user);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function patchWithHttpInfo($user_id, $user)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null) {
    ...
    {
        list($response) = $this->updateWithHttpInfo($user_id, $user);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function updateWithHttpInfo($user_id, $user)
    {
        // verify the required parameter 'user_id' is set
        if ($user_id === null) {
