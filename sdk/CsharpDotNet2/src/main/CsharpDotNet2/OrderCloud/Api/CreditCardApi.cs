...
namespace OrderCloud.Api
{
    ...
    public interface ICreditCardApi
    {
        ...
        /// <returns></returns>
        void DeleteAssignment (string buyerID, string creditCardID, string userID, string userGroupID);
        /// <summary>
        ///  
        /// </summary>
        /// <param name="buyerID">ID of the buyer.</param>
        ...
        /// <param name="pageSize">Number of results to return per page. Default: 20, max: 100.</param>
        /// <returns>Object</returns>
        Object ListAssignments (string buyerID, string creditCardID, string userID, string userGroupID, string level, int? page, int? pageSize);
        /// <summary>
        ///  
        /// </summary>
        /// <param name="buyerID">ID of the buyer.</param>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public class CreditCardApi : ICreditCardApi
    {
        /// <summary>
        ...
        /// <returns></returns>
        public CreditCardApi(ApiClient apiClient = null)
        {
        ...
        /// <param name="card"></param> 
        /// <returns>Object</returns>            
        public Object Create (string buyerID, CreditCard card)
        {
            ...
            if (card == null) throw new ApiException(400, "Missing required parameter 'card' when calling Create");
        ...
        /// <param name="creditCardID">ID of the credit card.</param> 
        /// <returns></returns>            
        public void Delete (string buyerID, string creditCardID)
        {
            ...
            if (creditCardID == null) throw new ApiException(400, "Missing required parameter 'creditCardID' when calling Delete");
...
path = path.Replace("{" + "creditCardID" + "}", ApiClient.ParameterToString(creditCardID));
        ...
        /// <param name="userGroupID">ID of the user group.</param> 
        /// <returns></returns>            
        public void DeleteAssignment (string buyerID, string creditCardID, string userID, string userGroupID)
        {
            ...
            // verify the required parameter 'creditCardID' is set
            if (creditCardID == null) throw new ApiException(400, "Missing required parameter 'creditCardID' when calling DeleteAssignment");
...
path = path.Replace("{" + "creditCardID" + "}", ApiClient.ParameterToString(creditCardID));
 ...
 if (userGroupID != null) queryParams.Add("userGroupID", ApiClient.ParameterToString(userGroupID)); // query parameter
        ...
        /// <param name="creditCardID">ID of the credit card.</param> 
        /// <returns>Object</returns>            
        public Object Get (string buyerID, string creditCardID)
        {
            ...
            // verify the required parameter 'creditCardID' is set
            if (creditCardID == null) throw new ApiException(400, "Missing required parameter 'creditCardID' when calling Get");
...
path = path.Replace("{" + "creditCardID" + "}", ApiClient.ParameterToString(creditCardID));
 ...
 if (pageSize != null) queryParams.Add("pageSize", ApiClient.ParameterToString(pageSize)); // query parameter
        ...
        /// <param name="pageSize">Number of results to return per page. Default: 20, max: 100.</param> 
        /// <returns>Object</returns>            
        public Object ListAssignments (string buyerID, string creditCardID, string userID, string userGroupID, string level, int? page, int? pageSize)
        {
            ...
            String postBody = null;
             ...
             if (creditCardID != null) queryParams.Add("creditCardID", ApiClient.ParameterToString(creditCardID)); // query parameter
 if (userID != null) queryParams.Add("userID", ApiClient.ParameterToString(userID)); // query parameter
 if (userGroupID != null) queryParams.Add("userGroupID", ApiClient.ParameterToString(userGroupID)); // query parameter
 ...
 if (pageSize != null) queryParams.Add("pageSize", ApiClient.ParameterToString(pageSize)); // query parameter
        ...
        /// <param name="card"></param> 
        /// <returns>Object</returns>            
        public Object Patch (string buyerID, string creditCardID, CreditCard card)
        {
            ...
            // verify the required parameter 'creditCardID' is set
            if (creditCardID == null) throw new ApiException(400, "Missing required parameter 'creditCardID' when calling Patch");
            
            // verify the required parameter 'card' is set
            if (card == null) throw new ApiException(400, "Missing required parameter 'card' when calling Patch");
...
path = path.Replace("{" + "creditCardID" + "}", ApiClient.ParameterToString(creditCardID));
        ...
        /// <param name="assignment"></param> 
        /// <returns></returns>            
        public void SaveAssignment (string buyerID, CreditCardAssignment assignment)
        {
        ...
        /// <param name="card"></param> 
        /// <returns>Object</returns>            
        public Object Update (string buyerID, string creditCardID, CreditCard card)
        {
            ...
            // verify the required parameter 'creditCardID' is set
            if (creditCardID == null) throw new ApiException(400, "Missing required parameter 'creditCardID' when calling Update");
            
            // verify the required parameter 'card' is set
            if (card == null) throw new ApiException(400, "Missing required parameter 'card' when calling Update");
