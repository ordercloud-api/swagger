...
module SwaggerClient
  ...
  class Product
    ...
    def hash
      [id, name, description, quantity_multiplier, ship_weight, active, type, inventory_enabled, inventory_notification_point, variant_level_inventory, xp, allow_order_exceed_inventory, inventory_visible].hash
    end
