...
# Unit tests for SwaggerClient::SpendingAccountApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SpendingAccountApi' do
  before do
    # run before each test
    @instance = SwaggerClient::SpendingAccountApi.new
  end
  ...
  describe 'test an instance of SpendingAccountApi' do
    it 'should create an instact of SpendingAccountApi' do
      expect(@instance).to be_instance_of(SwaggerClient::SpendingAccountApi)
    end
  end
