...
# Unit tests for SwaggerClient::PriceScheduleApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PriceScheduleApi' do
  before do
    # run before each test
    @instance = SwaggerClient::PriceScheduleApi.new
  end
  ...
  describe 'test an instance of PriceScheduleApi' do
    it 'should create an instact of PriceScheduleApi' do
      expect(@instance).to be_instance_of(SwaggerClient::PriceScheduleApi)
    end
  end
