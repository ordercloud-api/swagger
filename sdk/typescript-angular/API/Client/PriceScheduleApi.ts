...
namespace API.Client {
    ...
    export class PriceScheduleApi {
         ...
         */
        public _delete (priceScheduleID: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         * @param priceSchedule 
         */
        public create (priceSchedule: PriceSchedule, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
         ...
         */
        public deletePriceBreak (priceScheduleID: string, quantity: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         * @param priceScheduleID ID of the price schedule.
         */
        public get (priceScheduleID: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/priceschedules/{priceScheduleID}'
                .replace('{' + 'priceScheduleID' + '}', String(priceScheduleID));
         ...
         * @param priceSchedule 
         */
        public patch (priceScheduleID: string, priceSchedule: PriceSchedule, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/priceschedules/{priceScheduleID}'
                .replace('{' + 'priceScheduleID' + '}', String(priceScheduleID));
         ...
         * @param priceBreak 
         */
        public savePriceBreak (priceScheduleID: string, priceBreak: PriceBreak, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/priceschedules/{priceScheduleID}/PriceBreaks'
                .replace('{' + 'priceScheduleID' + '}', String(priceScheduleID));
         ...
         * @param priceSchedule 
         */
        public update (priceScheduleID: string, priceSchedule: PriceSchedule, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/priceschedules/{priceScheduleID}'
                .replace('{' + 'priceScheduleID' + '}', String(priceScheduleID));
