...
namespace API.Client {
    ...
    export class AddressApi {
         ...
         */
        public _delete (buyerID: string, addressID: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         * @param address 
         */
        public create (buyerID: string, address: Address, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
         ...
         */
        public deleteAssignment (buyerID: string, addressID: string, userID?: string, userGroupID?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         * @param addressID ID of the address.
         */
        public get (buyerID: string, addressID: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/buyers/{buyerID}/addresses/{addressID}'
                .replace('{' + 'buyerID' + '}', String(buyerID))
                .replace('{' + 'addressID' + '}', String(addressID));
         ...
         * @param pageSize Number of results to return per page. Default: 20, max: 100.
         */
        public listAssignments (buyerID: string, addressID?: string, userID?: string, userGroupID?: string, level?: string, isShipping?: boolean, isBilling?: boolean, page?: number, pageSize?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
         ...
         * @param address 
         */
        public patch (buyerID: string, addressID: string, address: Address, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/buyers/{buyerID}/addresses/{addressID}'
                .replace('{' + 'buyerID' + '}', String(buyerID))
                .replace('{' + 'addressID' + '}', String(addressID));
         ...
         * @param assignment 
         */
        public saveAssignment (buyerID: string, assignment: AddressAssignment, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
            const localVarPath = this.basePath + '/buyers/{buyerID}/addresses/assignments'
                .replace('{' + 'buyerID' + '}', String(buyerID));
         ...
         * @param address 
         */
        public update (buyerID: string, addressID: string, address: Address, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/buyers/{buyerID}/addresses/{addressID}'
                .replace('{' + 'buyerID' + '}', String(buyerID))
                .replace('{' + 'addressID' + '}', String(addressID));
