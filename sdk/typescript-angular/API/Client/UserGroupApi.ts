...
namespace API.Client {
    ...
    export class UserGroupApi {
         ...
         */
        public _delete (buyerID: string, userGroupID: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         * @param group 
         */
        public create (buyerID: string, group: UserGroup, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
         ...
         */
        public deleteUserAssignment (buyerID: string, userGroupID: string, userID: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         * @param userGroupID ID of the user group.
         */
        public get (buyerID: string, userGroupID: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/buyers/{buyerID}/usergroups/{userGroupID}'
                .replace('{' + 'buyerID' + '}', String(buyerID))
                .replace('{' + 'userGroupID' + '}', String(userGroupID));
         ...
         * @param pageSize Number of results to return per page. Default: 20, max: 100.
         */
        public listUserAssignments (buyerID: string, userGroupID?: string, userID?: string, page?: number, pageSize?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
         ...
         * @param group 
         */
        public patch (buyerID: string, userGroupID: string, group: UserGroup, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
            const localVarPath = this.basePath + '/buyers/{buyerID}/usergroups/{userGroupID}'
                .replace('{' + 'buyerID' + '}', String(buyerID))
                .replace('{' + 'userGroupID' + '}', String(userGroupID));
         ...
         */
        public saveUserAssignment (buyerID: string, userGroupAssignment: UserGroupAssignment, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
            const localVarPath = this.basePath + '/buyers/{buyerID}/usergroups/assignments'
                .replace('{' + 'buyerID' + '}', String(buyerID));
         ...
         * @param group 
         */
        public update (buyerID: string, userGroupID: string, group: UserGroup, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/buyers/{buyerID}/usergroups/{userGroupID}'
                .replace('{' + 'buyerID' + '}', String(buyerID))
                .replace('{' + 'userGroupID' + '}', String(userGroupID));
