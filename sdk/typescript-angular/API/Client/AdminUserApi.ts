...
namespace API.Client {
    ...
    export class AdminUserApi {
         ...
         */
        public _delete (userID: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         * @param user 
         */
        public create (user: User, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
         ...
         * @param userID ID of the user.
         */
        public get (userID: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/adminusers/{userID}'
                .replace('{' + 'userID' + '}', String(userID));
         ...
         * @param user 
         */
        public patch (userID: string, user: User, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
            const localVarPath = this.basePath + '/adminusers/{userID}'
                .replace('{' + 'userID' + '}', String(userID));
         ...
         * @param user 
         */
        public update (userID: string, user: User, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/adminusers/{userID}'
                .replace('{' + 'userID' + '}', String(userID));
