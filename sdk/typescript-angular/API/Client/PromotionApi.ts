...
namespace API.Client {
    ...
    export class PromotionApi {
         ...
         */
        public _delete (promotionID: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         * @param promo 
         */
        public create (promo: Promotion, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
         ...
         */
        public deleteAssignment (promotionID: string, buyerID: string, userID?: string, userGroupID?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         * @param promotionID ID of the promotion.
         */
        public get (promotionID: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/promotions/{promotionID}'
                .replace('{' + 'promotionID' + '}', String(promotionID));
         ...
         * @param pageSize Number of results to return per page. Default: 20, max: 100.
         */
        public listAssignments (buyerID: string, promotionID?: string, userID?: string, userGroupID?: string, level?: string, page?: number, pageSize?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
         ...
         */
        public patch (promotionID: string, partialPromotion: Promotion, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/promotions/{promotionID}'
                .replace('{' + 'promotionID' + '}', String(promotionID));
         ...
         * @param assignment 
         */
        public saveAssignment (assignment: PromotionAssignment, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
            const localVarPath = this.basePath + '/promotions/assignments';
         ...
         * @param promo 
         */
        public update (promotionID: string, promo: Promotion, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/promotions/{promotionID}'
                .replace('{' + 'promotionID' + '}', String(promotionID));
