...
namespace API.Client {
    ...
    export class BuyerApi {
         ...
         */
        public _delete (buyerID: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         * @param company 
         */
        public create (company: Buyer, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
         ...
         * @param buyerID ID of the buyer.
         */
        public get (buyerID: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/buyers/{buyerID}'
                .replace('{' + 'buyerID' + '}', String(buyerID));
         ...
         */
        public list (search?: string, page?: number, pageSize?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/buyers';
         ...
         * @param company 
         */
        public update (buyerID: string, company: Buyer, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/buyers/{buyerID}'
                .replace('{' + 'buyerID' + '}', String(buyerID));
