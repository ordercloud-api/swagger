...
namespace API.Client {
    ...
    export class CostCenterApi {
         ...
         */
        public _delete (buyerID: string, costCenterID: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         * @param costCenter 
         */
        public create (buyerID: string, costCenter: CostCenter, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
         ...
         */
        public deleteAssignment (buyerID: string, costCenterID: string, userID?: string, userGroupID?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
         ...
         * @param costCenterID ID of the cost center.
         */
        public get (buyerID: string, costCenterID: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/buyers/{buyerID}/costcenters/{costCenterID}'
                .replace('{' + 'buyerID' + '}', String(buyerID))
                .replace('{' + 'costCenterID' + '}', String(costCenterID));
         ...
         * @param pageSize Number of results to return per page. Default: 20, max: 100.
         */
        public listAssignments (buyerID: string, costCenterID?: string, userID?: string, userGroupID?: string, level?: string, page?: number, pageSize?: number, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
         ...
         * @param costCenter 
         */
        public patch (buyerID: string, costCenterID: string, costCenter: CostCenter, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/buyers/{buyerID}/costcenters/{costCenterID}'
                .replace('{' + 'buyerID' + '}', String(buyerID))
                .replace('{' + 'costCenterID' + '}', String(costCenterID));
         ...
         * @param assignment 
         */
        public saveAssignment (buyerID: string, assignment: CostCenterAssignment, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
            const localVarPath = this.basePath + '/buyers/{buyerID}/costcenters/assignments'
                .replace('{' + 'buyerID' + '}', String(buyerID));
         ...
         * @param costCenter 
         */
        public update (buyerID: string, costCenterID: string, costCenter: CostCenter, extraHttpRequestParams?: any ) : ng.IHttpPromise<any> {
            const localVarPath = this.basePath + '/buyers/{buyerID}/costcenters/{costCenterID}'
                .replace('{' + 'buyerID' + '}', String(buyerID))
                .replace('{' + 'costCenterID' + '}', String(costCenterID));
