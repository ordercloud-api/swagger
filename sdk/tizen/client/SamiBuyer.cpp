...
SamiBuyer*
SamiBuyer::fromJson(String* json) {
    this->cleanup();
...
void
SamiBuyer::fromJsonObject(IJsonValue* pJson) {
...
SamiBuyer::SamiBuyer(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
void
SamiBuyer::setPName(String* pName) {
    this->pName = pName;
}

Boolean*
SamiBuyer::getPActive() {
    return pActive;
}
void
SamiBuyer::setPActive(Boolean* pActive) {
...
void
SamiBuyer::setPXp(SamiObject* pXp) {
    this->pXp = pXp;
}
