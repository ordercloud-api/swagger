...
#ifndef _SWG_SWGBuyerApi_H_
#define _SWG_SWGBuyerApi_H_
...
class SWGBuyerApi: public QObject {
    Q_OBJECT

public:
    SWGBuyerApi();
    SWGBuyerApi(QString host, QString basePath);
    ~SWGBuyerApi();

    QString host;
    QString basePath;

    void create(SWGBuyer company);
    void delete(QString* buyerID);
    void get(QString* buyerID);
    void list(QString* search, qint32 page, qint32 pageSize);
    void update(QString* buyerID, SWGBuyer company);
