...
#ifndef _SWG_SWGPromotionApi_H_
#define _SWG_SWGPromotionApi_H_
...
class SWGPromotionApi: public QObject {
    Q_OBJECT

public:
    SWGPromotionApi();
    SWGPromotionApi(QString host, QString basePath);
    ~SWGPromotionApi();

    QString host;
    QString basePath;

    void create(SWGPromotion promo);
    void delete(QString* promotionID);
    void deleteAssignment(QString* promotionID, QString* buyerID, QString* userID, QString* userGroupID);
    void get(QString* promotionID);
    void list(QString* search, QString* searchOn, QString* sortBy, qint32 page, qint32 pageSize);
    void listAssignments(QString* buyerID, QString* promotionID, QString* userID, QString* userGroupID, QString* level, qint32 page, qint32 pageSize);
    void patch(QString* promotionID, SWGPromotion partialPromotion);
    void saveAssignment(SWGPromotionAssignment assignment);
    void update(QString* promotionID, SWGPromotion promo);
