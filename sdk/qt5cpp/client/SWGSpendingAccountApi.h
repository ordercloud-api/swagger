...
#ifndef _SWG_SWGSpendingAccountApi_H_
#define _SWG_SWGSpendingAccountApi_H_
...
class SWGSpendingAccountApi: public QObject {
    Q_OBJECT

public:
    SWGSpendingAccountApi();
    SWGSpendingAccountApi(QString host, QString basePath);
    ~SWGSpendingAccountApi();

    QString host;
    QString basePath;

    void create(QString* buyerID, SWGSpendingAccount spendingAccount);
    void delete(QString* buyerID, QString* spendingAccountID);
    void deleteAssignment(QString* buyerID, QString* spendingAccountID, QString* userID, QString* userGroupID);
    void get(QString* buyerID, QString* spendingAccountID);
    void list(QString* buyerID, QString* search, QString* searchOn, QString* sortBy, qint32 page, qint32 pageSize);
    void listAssignments(QString* buyerID, QString* spendingAccountID, QString* userID, QString* userGroupID, QString* level, qint32 page, qint32 pageSize);
    void patch(QString* buyerID, QString* spendingAccountID, SWGSpendingAccount spendingAccount);
    void saveAssignment(QString* buyerID, SWGSpendingAccountAssignment assignment);
    void update(QString* buyerID, QString* spendingAccountID, SWGSpendingAccount spendingAccount);
