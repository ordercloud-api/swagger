...
@Api(value = "SecurityProfiles", description = "the SecurityProfiles API")
public interface SecurityProfilesApi {
    ...
    @RequestMapping(value = "/SecurityProfiles/{securityProfileID}",
        method = RequestMethod.GET)
    ResponseEntity<Object> get(@ApiParam(value = "ID of the security profile.",required=true ) @PathVariable("securityProfileID") String securityProfileID);
