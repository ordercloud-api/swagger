...
public class AdminusersApiController implements AdminusersApi {
    ...
    public ResponseEntity<Object> create(@ApiParam(value = "" ,required=true ) @RequestBody User user) {
        // do some magic!
        return new ResponseEntity<Object>(HttpStatus.OK);
    }

    public ResponseEntity<Void> delete(@ApiParam(value = "ID of the user.",required=true ) @PathVariable("userID") String userID) {
        // do some magic!
        return new ResponseEntity<Void>(HttpStatus.OK);
    }

    public ResponseEntity<Object> get(@ApiParam(value = "ID of the user.",required=true ) @PathVariable("userID") String userID) {
        // do some magic!
        return new ResponseEntity<Object>(HttpStatus.OK);
    }
    ...
    public ResponseEntity<Void> patch(@ApiParam(value = "ID of the user.",required=true ) @PathVariable("userID") String userID,
        @ApiParam(value = "" ,required=true ) @RequestBody User user) {
        // do some magic!
        return new ResponseEntity<Void>(HttpStatus.OK);
    }

    public ResponseEntity<Object> update(@ApiParam(value = "ID of the user.",required=true ) @PathVariable("userID") String userID,
        @ApiParam(value = "" ,required=true ) @RequestBody User user) {
        // do some magic!
        return new ResponseEntity<Object>(HttpStatus.OK);
    }
