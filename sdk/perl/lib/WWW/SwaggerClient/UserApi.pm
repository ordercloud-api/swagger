...
sub create {
    ...
    unless (exists $args{'user'}) {
      croak("Missing the required parameter 'user' when calling create");
    }

    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/users';
...
sub delete {
    ...
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling delete");
    }

    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/users/{userID}';
    $_resource_path =~ s/{format}/json/; # default format to json
...
sub get {
    ...
    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling get");
    }
...
# @param ImpersonateTokenRequest $token_request  (required)
{
    ...
    'token_request' => {
        data_type => 'ImpersonateTokenRequest',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'get_access_token' } = { 
    	summary => '',
        params => $params,
        returns => 'object',
        };
...
sub get_access_token {
    ...
    # verify the required parameter 'buyer_id' is set
    unless (exists $args{'buyer_id'}) {
      croak("Missing the required parameter 'buyer_id' when calling get_access_token");
    }

    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling get_access_token");
    }

    # verify the required parameter 'token_request' is set
    unless (exists $args{'token_request'}) {
      croak("Missing the required parameter 'token_request' when calling get_access_token");
    }

    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/users/{userID}/accesstoken';
    $_resource_path =~ s/{format}/json/; # default format to json
    ...
    my $_body_data;
    # body params
    if ( exists $args{'token_request'}) {
        $_body_data = $args{'token_request'};
    }
...
sub patch {
    ...
    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling patch");
    }
...
sub update {
    ...
    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling update");
    }
