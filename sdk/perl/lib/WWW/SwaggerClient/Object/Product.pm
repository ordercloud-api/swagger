...
__PACKAGE__->method_documentation({
    ...
    'inventory_notification_point' => {
    	datatype => 'int',
    	base_name => 'InventoryNotificationPoint',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'variant_level_inventory' => {
    	datatype => 'boolean',
    	base_name => 'VariantLevelInventory',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    ...
    'allow_order_exceed_inventory' => {
    	datatype => 'boolean',
    	base_name => 'AllowOrderExceedInventory',
    	description => '',
    	format => '',
    	read_only => '',
    		},
