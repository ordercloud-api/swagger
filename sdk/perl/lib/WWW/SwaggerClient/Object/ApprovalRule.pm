...
#
package WWW::SwaggerClient::Object::ApprovalRule;
...
__PACKAGE__->method_documentation({
    ...
    'scope_start_date' => {
    	datatype => 'DateTime',
    	base_name => 'ScopeStartDate',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'expire_after_time_unit' => {
    	datatype => 'string',
    	base_name => 'ExpireAfterTimeUnit',
    	description => '',
    	format => '',
    	read_only => '',
    		},
