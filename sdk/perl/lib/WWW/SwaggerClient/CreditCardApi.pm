...
#
package WWW::SwaggerClient::CreditCardApi;
...
sub create {
    ...
    unless (exists $args{'card'}) {
      croak("Missing the required parameter 'card' when calling create");
    }

    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/creditcards';
...
sub delete {
    ...
    unless (exists $args{'credit_card_id'}) {
      croak("Missing the required parameter 'credit_card_id' when calling delete");
    }

    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/creditcards/{creditCardID}';
    $_resource_path =~ s/{format}/json/; # default format to json
    ...
    # path params
    if ( exists $args{'credit_card_id'}) {
        my $_base_variable = "{" . "creditCardID" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'credit_card_id'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
...
sub delete_assignment {
    ...
    # verify the required parameter 'credit_card_id' is set
    unless (exists $args{'credit_card_id'}) {
      croak("Missing the required parameter 'credit_card_id' when calling delete_assignment");
    }

    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/creditcards/{creditCardID}/assignments';
    $_resource_path =~ s/{format}/json/; # default format to json
...
sub get {
    ...
    # verify the required parameter 'credit_card_id' is set
    unless (exists $args{'credit_card_id'}) {
      croak("Missing the required parameter 'credit_card_id' when calling get");
    }
...
sub list_assignments {
    ...
    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/creditcards/assignments';
    $_resource_path =~ s/{format}/json/; # default format to json
    ...
    # query params
    if ( exists $args{'credit_card_id'}) {
        $query_params->{'creditCardID'} = $self->{api_client}->to_query_value($args{'credit_card_id'});
    }
...
sub patch {
    ...
    # verify the required parameter 'credit_card_id' is set
    unless (exists $args{'credit_card_id'}) {
      croak("Missing the required parameter 'credit_card_id' when calling patch");
    }

    # verify the required parameter 'card' is set
    unless (exists $args{'card'}) {
      croak("Missing the required parameter 'card' when calling patch");
    }
...
# @param CreditCardAssignment $assignment  (required)
{
    ...
    'assignment' => {
        data_type => 'CreditCardAssignment',
        description => '',
        required => '1',
    },
    };
...
sub update {
    ...
    # verify the required parameter 'credit_card_id' is set
    unless (exists $args{'credit_card_id'}) {
      croak("Missing the required parameter 'credit_card_id' when calling update");
    }

    # verify the required parameter 'card' is set
    unless (exists $args{'card'}) {
      croak("Missing the required parameter 'card' when calling update");
    }
