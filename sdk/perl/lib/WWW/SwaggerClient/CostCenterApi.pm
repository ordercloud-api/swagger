...
#
package WWW::SwaggerClient::CostCenterApi;
...
sub create {
    ...
    unless (exists $args{'cost_center'}) {
      croak("Missing the required parameter 'cost_center' when calling create");
    }

    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/costcenters';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'cost_center'}) {
        $_body_data = $args{'cost_center'};
    }
...
sub delete {
    ...
    unless (exists $args{'cost_center_id'}) {
      croak("Missing the required parameter 'cost_center_id' when calling delete");
    }

    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/costcenters/{costCenterID}';
    $_resource_path =~ s/{format}/json/; # default format to json
    ...
    # path params
    if ( exists $args{'cost_center_id'}) {
        my $_base_variable = "{" . "costCenterID" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'cost_center_id'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
...
sub delete_assignment {
    ...
    # verify the required parameter 'cost_center_id' is set
    unless (exists $args{'cost_center_id'}) {
      croak("Missing the required parameter 'cost_center_id' when calling delete_assignment");
    }

    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/costcenters/{costCenterID}/assignments';
    $_resource_path =~ s/{format}/json/; # default format to json
...
sub get {
    ...
    # verify the required parameter 'cost_center_id' is set
    unless (exists $args{'cost_center_id'}) {
      croak("Missing the required parameter 'cost_center_id' when calling get");
    }
...
sub list_assignments {
    ...
    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/costcenters/assignments';
    $_resource_path =~ s/{format}/json/; # default format to json
    ...
    # query params
    if ( exists $args{'cost_center_id'}) {
        $query_params->{'costCenterID'} = $self->{api_client}->to_query_value($args{'cost_center_id'});
    }
...
sub patch {
    ...
    # verify the required parameter 'cost_center_id' is set
    unless (exists $args{'cost_center_id'}) {
      croak("Missing the required parameter 'cost_center_id' when calling patch");
    }

    # verify the required parameter 'cost_center' is set
    unless (exists $args{'cost_center'}) {
      croak("Missing the required parameter 'cost_center' when calling patch");
    }
...
# @param CostCenterAssignment $assignment  (required)
{
    ...
    'assignment' => {
        data_type => 'CostCenterAssignment',
        description => '',
        required => '1',
    },
    };
...
sub update {
    ...
    # verify the required parameter 'cost_center_id' is set
    unless (exists $args{'cost_center_id'}) {
      croak("Missing the required parameter 'cost_center_id' when calling update");
    }

    # verify the required parameter 'cost_center' is set
    unless (exists $args{'cost_center'}) {
      croak("Missing the required parameter 'cost_center' when calling update");
    }
