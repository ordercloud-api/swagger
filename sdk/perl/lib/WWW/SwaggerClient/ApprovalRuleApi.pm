...
#
package WWW::SwaggerClient::ApprovalRuleApi;
...
sub create {
    ...
    unless (exists $args{'approval_rule'}) {
      croak("Missing the required parameter 'approval_rule' when calling create");
    }

    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/approvalrules';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'approval_rule'}) {
        $_body_data = $args{'approval_rule'};
    }
...
sub delete {
    ...
    unless (exists $args{'approval_rule_id'}) {
      croak("Missing the required parameter 'approval_rule_id' when calling delete");
    }

    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/approvalrules/{approvalRuleID}';
    $_resource_path =~ s/{format}/json/; # default format to json
    ...
    # path params
    if ( exists $args{'approval_rule_id'}) {
        my $_base_variable = "{" . "approvalRuleID" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'approval_rule_id'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
...
sub get {
    ...
    # verify the required parameter 'approval_rule_id' is set
    unless (exists $args{'approval_rule_id'}) {
      croak("Missing the required parameter 'approval_rule_id' when calling get");
    }
...
sub patch {
    ...
    # verify the required parameter 'approval_rule_id' is set
    unless (exists $args{'approval_rule_id'}) {
      croak("Missing the required parameter 'approval_rule_id' when calling patch");
    }

    # verify the required parameter 'partial_approval_rule' is set
    unless (exists $args{'partial_approval_rule'}) {
      croak("Missing the required parameter 'partial_approval_rule' when calling patch");
    }
    ...
    my $_body_data;
    # body params
    if ( exists $args{'partial_approval_rule'}) {
        $_body_data = $args{'partial_approval_rule'};
    }
...
sub update {
    ...
    # verify the required parameter 'approval_rule_id' is set
    unless (exists $args{'approval_rule_id'}) {
      croak("Missing the required parameter 'approval_rule_id' when calling update");
    }

    # verify the required parameter 'approval_rule' is set
    unless (exists $args{'approval_rule'}) {
      croak("Missing the required parameter 'approval_rule' when calling update");
    }
