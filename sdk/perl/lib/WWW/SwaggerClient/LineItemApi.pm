...
#
package WWW::SwaggerClient::LineItemApi;
...
sub create {
    ...
    unless (exists $args{'line_item'}) {
      croak("Missing the required parameter 'line_item' when calling create");
    }

    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/orders/{orderID}/lineitems';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'line_item'}) {
        $_body_data = $args{'line_item'};
    }
...
sub delete {
    ...
    unless (exists $args{'line_item_id'}) {
      croak("Missing the required parameter 'line_item_id' when calling delete");
    }

    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/orders/{orderID}/lineitems/{lineItemID}';
    $_resource_path =~ s/{format}/json/; # default format to json
...
sub get {
    ...
    # verify the required parameter 'line_item_id' is set
    unless (exists $args{'line_item_id'}) {
      croak("Missing the required parameter 'line_item_id' when calling get");
    }
...
sub patch {
    ...
    # verify the required parameter 'line_item_id' is set
    unless (exists $args{'line_item_id'}) {
      croak("Missing the required parameter 'line_item_id' when calling patch");
    }

    # verify the required parameter 'partial_line_item' is set
    unless (exists $args{'partial_line_item'}) {
      croak("Missing the required parameter 'partial_line_item' when calling patch");
    }
    ...
    my $_body_data;
    # body params
    if ( exists $args{'partial_line_item'}) {
        $_body_data = $args{'partial_line_item'};
    }
...
sub patch_shipping_address {
    ...
    # verify the required parameter 'line_item_id' is set
    unless (exists $args{'line_item_id'}) {
      croak("Missing the required parameter 'line_item_id' when calling patch_shipping_address");
    }
    ...
    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/orders/{orderID}/lineitems/{lineItemID}/shipto';
    $_resource_path =~ s/{format}/json/; # default format to json
...
sub set_shipping_address {
    ...
    # verify the required parameter 'line_item_id' is set
    unless (exists $args{'line_item_id'}) {
      croak("Missing the required parameter 'line_item_id' when calling set_shipping_address");
    }
...
sub update {
    ...
    # verify the required parameter 'line_item_id' is set
    unless (exists $args{'line_item_id'}) {
      croak("Missing the required parameter 'line_item_id' when calling update");
    }

    # verify the required parameter 'line_item' is set
    unless (exists $args{'line_item'}) {
      croak("Missing the required parameter 'line_item' when calling update");
    }
