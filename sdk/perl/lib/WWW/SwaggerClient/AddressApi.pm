...
sub create {
    ...
    unless (exists $args{'address'}) {
      croak("Missing the required parameter 'address' when calling create");
    }

    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/addresses';
...
sub delete {
    ...
    unless (exists $args{'address_id'}) {
      croak("Missing the required parameter 'address_id' when calling delete");
    }

    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/addresses/{addressID}';
    $_resource_path =~ s/{format}/json/; # default format to json
...
sub delete_assignment {
    ...
    # verify the required parameter 'address_id' is set
    unless (exists $args{'address_id'}) {
      croak("Missing the required parameter 'address_id' when calling delete_assignment");
    }

    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/addresses/{addressID}/assignments';
    $_resource_path =~ s/{format}/json/; # default format to json
...
sub get {
    ...
    # verify the required parameter 'address_id' is set
    unless (exists $args{'address_id'}) {
      croak("Missing the required parameter 'address_id' when calling get");
    }
...
# @param boolean $is_shipping Is shipping of the address. (optional)
# @param boolean $is_billing Is billing of the address. (optional)
# @param int $page Page of results to return. Default: 1 (optional)
# @param int $page_size Number of results to return per page. Default: 20, max: 100. (optional)
{
    my $params = {
...
sub list_assignments {
    ...
    # parse inputs
    my $_resource_path = '/buyers/{buyerID}/addresses/assignments';
    $_resource_path =~ s/{format}/json/; # default format to json
    ...
    # query params
    if ( exists $args{'address_id'}) {
        $query_params->{'addressID'} = $self->{api_client}->to_query_value($args{'address_id'});
    }
    ...
    # query params
    if ( exists $args{'is_shipping'}) {
        $query_params->{'isShipping'} = $self->{api_client}->to_query_value($args{'is_shipping'});
    }

    # query params
    if ( exists $args{'is_billing'}) {
        $query_params->{'isBilling'} = $self->{api_client}->to_query_value($args{'is_billing'});
    }
...
sub patch {
    ...
    # verify the required parameter 'address_id' is set
    unless (exists $args{'address_id'}) {
      croak("Missing the required parameter 'address_id' when calling patch");
    }

    # verify the required parameter 'address' is set
    unless (exists $args{'address'}) {
      croak("Missing the required parameter 'address' when calling patch");
    }
...
sub update {
    ...
    # verify the required parameter 'address_id' is set
    unless (exists $args{'address_id'}) {
      croak("Missing the required parameter 'address_id' when calling update");
    }

    # verify the required parameter 'address' is set
    unless (exists $args{'address'}) {
      croak("Missing the required parameter 'address' when calling update");
    }
