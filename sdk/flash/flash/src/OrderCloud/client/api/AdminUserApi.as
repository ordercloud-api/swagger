...
public class AdminUserApi extends SwaggerApi {
    /**
    * Constructor for the AdminUserApi api client
    * @param apiCredentials Wrapper object for tokens and hostName required towards authentication
    * @param eventDispatcher Optional event dispatcher that when provided is used by the SDK to dispatch any Response
    */
    public function AdminUserApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
     ...
     * Returns void 
     */
    public function call_delete (userID: String): String {
        // create path and map variables
        var path: String = "/adminusers/{userID}".replace(/{format}/g,"xml").replace("{" + "userID" + "}", getApiInvoker().escapeString(userID));
    ...
    public function create (user: User): String {
        // create path and map variables
        var path: String = "/adminusers".replace(/{format}/g,"xml");
     ...
     * Returns Object 
     */
    public function get (userID: String): String {
        // create path and map variables
        var path: String = "/adminusers/{userID}".replace(/{format}/g,"xml").replace("{" + "userID" + "}", getApiInvoker().escapeString(userID));
...
if("null" != String(pageSize))
     ...
     * Returns void 
     */
    public function patch (userID: String, user: User): String {
        // create path and map variables
        var path: String = "/adminusers/{userID}".replace(/{format}/g,"xml").replace("{" + "userID" + "}", getApiInvoker().escapeString(userID));
     ...
     * Returns Object 
     */
    public function update (userID: String, user: User): String {
        // create path and map variables
        var path: String = "/adminusers/{userID}".replace(/{format}/g,"xml").replace("{" + "userID" + "}", getApiInvoker().escapeString(userID));
