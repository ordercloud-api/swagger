...
export class SpendingAccountApi {
     ...
     */
    public _delete (buyerID: string, spendingAccountID: string, extraHttpRequestParams?: any ) : Observable<{}> {
        const path = this.basePath + '/buyers/{buyerID}/spendingaccounts/{spendingAccountID}'
     ...
     */
    public create (buyerID: string, spendingAccount: models.SpendingAccount, extraHttpRequestParams?: any ) : Observable<any> {
        const path = this.basePath + '/buyers/{buyerID}/spendingaccounts'
            .replace('{' + 'buyerID' + '}', String(buyerID));
        ...
        requestOptions.body = JSON.stringify(spendingAccount);
     ...
     */
    public deleteAssignment (buyerID: string, spendingAccountID: string, userID?: string, userGroupID?: string, extraHttpRequestParams?: any ) : Observable<{}> {
        const path = this.basePath + '/buyers/{buyerID}/spendingaccounts/{spendingAccountID}/assignments'
            .replace('{' + 'buyerID' + '}', String(buyerID))
            .replace('{' + 'spendingAccountID' + '}', String(spendingAccountID));
     ...
     * @param spendingAccountID ID of the spending account.
     */
    public get (buyerID: string, spendingAccountID: string, extraHttpRequestParams?: any ) : Observable<any> {
        const path = this.basePath + '/buyers/{buyerID}/spendingaccounts/{spendingAccountID}'
            .replace('{' + 'buyerID' + '}', String(buyerID))
            .replace('{' + 'spendingAccountID' + '}', String(spendingAccountID));
     ...
     * @param pageSize Number of results to return per page. Default: 20, max: 100.
     */
    public listAssignments (buyerID: string, spendingAccountID?: string, userID?: string, userGroupID?: string, level?: string, page?: number, pageSize?: number, extraHttpRequestParams?: any ) : Observable<any> {
        const path = this.basePath + '/buyers/{buyerID}/spendingaccounts/assignments'
            .replace('{' + 'buyerID' + '}', String(buyerID));
        ...
        if (spendingAccountID !== undefined) {
            queryParameters.set('spendingAccountID', String(spendingAccountID));
        }
     ...
     * @param spendingAccount 
     */
    public patch (buyerID: string, spendingAccountID: string, spendingAccount: models.SpendingAccount, extraHttpRequestParams?: any ) : Observable<any> {
        const path = this.basePath + '/buyers/{buyerID}/spendingaccounts/{spendingAccountID}'
            .replace('{' + 'buyerID' + '}', String(buyerID))
            .replace('{' + 'spendingAccountID' + '}', String(spendingAccountID));
     ...
     * @param assignment 
     */
    public saveAssignment (buyerID: string, assignment: models.SpendingAccountAssignment, extraHttpRequestParams?: any ) : Observable<{}> {
        const path = this.basePath + '/buyers/{buyerID}/spendingaccounts/assignments'
            .replace('{' + 'buyerID' + '}', String(buyerID));
     ...
     * @param spendingAccount 
     */
    public update (buyerID: string, spendingAccountID: string, spendingAccount: models.SpendingAccount, extraHttpRequestParams?: any ) : Observable<any> {
        const path = this.basePath + '/buyers/{buyerID}/spendingaccounts/{spendingAccountID}'
            .replace('{' + 'buyerID' + '}', String(buyerID))
            .replace('{' + 'spendingAccountID' + '}', String(spendingAccountID));
