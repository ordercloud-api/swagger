...
export class PromotionApi {
     ...
     */
    public _delete (promotionID: string, extraHttpRequestParams?: any ) : Observable<{}> {
        const path = this.basePath + '/promotions/{promotionID}'
     ...
     * @param promo 
     */
    public create (promo: models.Promotion, extraHttpRequestParams?: any ) : Observable<any> {
        const path = this.basePath + '/promotions';
        ...
        requestOptions.body = JSON.stringify(promo);
     ...
     */
    public deleteAssignment (promotionID: string, buyerID: string, userID?: string, userGroupID?: string, extraHttpRequestParams?: any ) : Observable<{}> {
        const path = this.basePath + '/promotions/{promotionID}/assignments'
            .replace('{' + 'promotionID' + '}', String(promotionID));
     ...
     * @param promotionID ID of the promotion.
     */
    public get (promotionID: string, extraHttpRequestParams?: any ) : Observable<any> {
        const path = this.basePath + '/promotions/{promotionID}'
            .replace('{' + 'promotionID' + '}', String(promotionID));
     ...
     * @param pageSize Number of results to return per page. Default: 20, max: 100.
     */
    public listAssignments (buyerID: string, promotionID?: string, userID?: string, userGroupID?: string, level?: string, page?: number, pageSize?: number, extraHttpRequestParams?: any ) : Observable<any> {
        const path = this.basePath + '/promotions/assignments';
        ...
        if (promotionID !== undefined) {
            queryParameters.set('promotionID', String(promotionID));
        }
     ...
     */
    public patch (promotionID: string, partialPromotion: models.Promotion, extraHttpRequestParams?: any ) : Observable<any> {
        const path = this.basePath + '/promotions/{promotionID}'
            .replace('{' + 'promotionID' + '}', String(promotionID));
        ...
        requestOptions.body = JSON.stringify(partialPromotion);
     ...
     * @param assignment 
     */
    public saveAssignment (assignment: models.PromotionAssignment, extraHttpRequestParams?: any ) : Observable<{}> {
        const path = this.basePath + '/promotions/assignments';
     ...
     * @param promo 
     */
    public update (promotionID: string, promo: models.Promotion, extraHttpRequestParams?: any ) : Observable<any> {
        const path = this.basePath + '/promotions/{promotionID}'
            .replace('{' + 'promotionID' + '}', String(promotionID));
