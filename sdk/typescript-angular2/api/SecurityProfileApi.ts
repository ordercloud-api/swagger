...
export class SecurityProfileApi {
     ...
     */
    public get (securityProfileID: string, extraHttpRequestParams?: any ) : Observable<any> {
        const path = this.basePath + '/SecurityProfiles/{securityProfileID}'
    ...
    public list (search?: string, searchOn?: string, sortBy?: string, page?: number, pageSize?: number, extraHttpRequestParams?: any ) : Observable<any> {
        const path = this.basePath + '/SecurityProfiles';
