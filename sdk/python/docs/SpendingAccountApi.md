...
# **get**
> get(buyer_id, spending_account_id)
...
try: 
    api_instance.get(buyer_id, spending_account_id)
except ApiException as e:
...
# **list**
> object list(buyer_id, spending_account, search=search, search_on=search_on, sort_by=sort_by, page=page, page_size=page_size)
...
try: 
    api_response = api_instance.list(buyer_id, spending_account, search=search, search_on=search_on, sort_by=sort_by, page=page, page_size=page_size)
    pprint(api_response)
except ApiException as e:
...
# **list_assignments**
> list_assignments(buyer_id, assignment, spending_account_id=spending_account_id, user_id=user_id, user_group_id=user_group_id, level=level, page=page, page_size=page_size)
...
try: 
    api_instance.list_assignments(buyer_id, assignment, spending_account_id=spending_account_id, user_id=user_id, user_group_id=user_group_id, level=level, page=page, page_size=page_size)
except ApiException as e:
...
# **patch**
> patch(buyer_id, spending_account_id)
...
try: 
    api_instance.patch(buyer_id, spending_account_id)
except ApiException as e:
...
# **update**
> update(buyer_id, spending_account_id)
...
try: 
    api_instance.update(buyer_id, spending_account_id)
except ApiException as e:
