...
# **list**
> object list(promo, search=search, search_on=search_on, sort_by=sort_by, page=page, page_size=page_size)
...
try: 
    api_response = api_instance.list(promo, search=search, search_on=search_on, sort_by=sort_by, page=page, page_size=page_size)
    pprint(api_response)
except ApiException as e:
...
# **list_assignments**
> list_assignments(buyer_id, assignment, promotion_id=promotion_id, user_id=user_id, user_group_id=user_group_id, level=level, page=page, page_size=page_size)
...
try: 
    api_instance.list_assignments(buyer_id, assignment, promotion_id=promotion_id, user_id=user_id, user_group_id=user_group_id, level=level, page=page, page_size=page_size)
except ApiException as e:
...
try: 
    api_instance.patch(promotion_id)
except ApiException as e:
...
try: 
    api_instance.update(promotion_id)
except ApiException as e:
