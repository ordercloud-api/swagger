...
namespace OrderCloud.Api
{
    ...
    /// </summary>
    public interface ISecurityProfileApi : IApiAccessor
    {
        ...
        ApiResponse<Object> GetWithHttpInfo (string securityProfileID);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Object> GetAsync (string securityProfileID);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> GetAsyncWithHttpInfo (string securityProfileID);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class SecurityProfileApi : ISecurityProfileApi
    {
        ...
        /// <returns></returns>
        public SecurityProfileApi(Configuration configuration = null)
        {
        ...
        {
             ApiResponse<Object> localVarResponse = GetWithHttpInfo(securityProfileID);
        ...
        /// <param name="securityProfileID">ID of the security profile.</param>
        /// <returns>ApiResponse of Object</returns>
        public ApiResponse< Object > GetWithHttpInfo (string securityProfileID)
        {
            // verify the required parameter 'securityProfileID' is set
            if (securityProfileID == null)
                throw new ApiException(400, "Missing required parameter 'securityProfileID' when calling SecurityProfileApi->Get");

            var localVarPath = "/SecurityProfiles/{securityProfileID}";
        ...
        /// <param name="securityProfileID">ID of the security profile.</param>
        /// <returns>Task of Object</returns>
        public async System.Threading.Tasks.Task<Object> GetAsync (string securityProfileID)
        {
             ApiResponse<Object> localVarResponse = await GetAsyncWithHttpInfo(securityProfileID);
             return localVarResponse.Data;
        ...
        /// <param name="securityProfileID">ID of the security profile.</param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> GetAsyncWithHttpInfo (string securityProfileID)
        {
            // verify the required parameter 'securityProfileID' is set
            if (securityProfileID == null)
                throw new ApiException(400, "Missing required parameter 'securityProfileID' when calling SecurityProfileApi->Get");
        ...
        public ApiResponse< Object > ListWithHttpInfo (string search = null, string searchOn = null, string sortBy = null, int? page = null, int? pageSize = null)
        {
            ...
            var localVarPath = "/SecurityProfiles";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
