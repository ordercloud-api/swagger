...
namespace OrderCloud.Model
{
    ...
    public partial class Payment :  IEquatable<Payment>
    {
        ...
        public Payment(string ID = null, string Type = null, string CreditCardID = null, string SpendingAccountID = null, string Description = null, decimal? Amount = null, Object Xp = null)
        {
            this.ID = ID;
            this.Type = Type;
