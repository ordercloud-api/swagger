...
namespace OrderCloud.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CostCenterAssignment :  IEquatable<CostCenterAssignment>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CostCenterAssignment" /> class.
        /// </summary>
        /// <param name="CostCenterID">CostCenterID.</param>
        /// <param name="UserID">UserID.</param>
        /// <param name="UserGroupID">UserGroupID.</param>
        public CostCenterAssignment(string CostCenterID = null, string UserID = null, string UserGroupID = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CostCenterAssignment);
        }

        /// <summary>
        /// Returns true if CostCenterAssignment instances are equal
        /// </summary>
        /// <param name="other">Instance of CostCenterAssignment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CostCenterAssignment other)
        {
            ...
            return 
                (
                    ...
                    this.CostCenterID.Equals(other.CostCenterID)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CostCenterID != null)
                    hash = hash * 59 + this.CostCenterID.GetHashCode();
                if (this.UserID != null)
