...
public class SecurityProfileApi {
  ...
  * 
   ...
   * @return Object
  */
  public Object get (String securityProfileID) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
  
      // verify the required parameter 'securityProfileID' is set
      if (securityProfileID == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'securityProfileID' when calling get",
      new ApiException(400, "Missing the required parameter 'securityProfileID' when calling get"));
      }
  

  // create path and map variables
  String path = "/SecurityProfiles/{securityProfileID}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "securityProfileID" + "\\}", apiInvoker.escapeString(securityProfileID.toString()));
   ...
   * @param securityProfileID ID of the security profile.
  */
  public void get (String securityProfileID, final Response.Listener<Object> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  ...
  // create path and map variables
  String path = "/SecurityProfiles".replaceAll("\\{format\\}","json");
