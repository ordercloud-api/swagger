#import "SWGSecurityProfileApi.h"
#import "SWGQueryParamCollection.h"


@interface SWGSecurityProfileApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGSecurityProfileApi

NSString* kSWGSecurityProfileApiErrorDomain = @"SWGSecurityProfileApiErrorDomain";
NSInteger kSWGSecurityProfileApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGSecurityProfileApi *sharedAPI;
...
-(NSNumber*) getWithSecurityProfileID: (NSString*) securityProfileID
    ...
    if (securityProfileID == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGSecurityProfileApiErrorDomain code:kSWGSecurityProfileApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/SecurityProfiles/{securityProfileID}"];
...
-(NSNumber*) listWithSearch: (NSString*) search
    ...
    completionHandler: (void (^)(NSObject* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/SecurityProfiles"];
