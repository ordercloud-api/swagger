#import "SWGAdminUserApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGUser.h"


@interface SWGAdminUserApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGAdminUserApi

NSString* kSWGAdminUserApiErrorDomain = @"SWGAdminUserApiErrorDomain";
NSInteger kSWGAdminUserApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGAdminUserApi *sharedAPI;
...
-(NSNumber*) createWithUser: (SWGUser*) user
    ...
    if (user == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGAdminUserApiErrorDomain code:kSWGAdminUserApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/adminusers"];
...
-(NSNumber*) deleteWithUserID: (NSString*) userID
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/adminusers/{userID}"];
