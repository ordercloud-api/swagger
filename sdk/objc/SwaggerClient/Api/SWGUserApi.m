...
-(NSNumber*) createWithBuyerID: (NSString*) buyerID
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/buyers/{buyerID}/users"];
...
-(NSNumber*) deleteWithBuyerID: (NSString*) buyerID
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/buyers/{buyerID}/users/{userID}"];
...
-(NSNumber*) getAccessTokenWithBuyerID: (NSString*) buyerID
    ...
    if (tokenRequest == nil) {
        NSParameterAssert(tokenRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"tokenRequest"] };
            NSError* error = [NSError errorWithDomain:kSWGUserApiErrorDomain code:kSWGUserApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/buyers/{buyerID}/users/{userID}/accesstoken"];
