#import "SWGBuyerApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGBuyer.h"


@interface SWGBuyerApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGBuyerApi

NSString* kSWGBuyerApiErrorDomain = @"SWGBuyerApiErrorDomain";
NSInteger kSWGBuyerApiMissingParamErrorCode = 234513;
...
-(NSNumber*) createWithCompany: (SWGBuyer*) company
    ...
    if (company == nil) {
        ...
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"company"] };
            NSError* error = [NSError errorWithDomain:kSWGBuyerApiErrorDomain code:kSWGBuyerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/buyers"];
...
-(NSNumber*) deleteWithBuyerID: (NSString*) buyerID
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/buyers/{buyerID}"];
